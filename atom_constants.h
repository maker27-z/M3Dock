...
//Xscore
const sz  XSCORE_TYPE_C_3     = 1 ;
const sz  XSCORE_TYPE_C_3_x   = 2 ;
const sz  XSCORE_TYPE_C_3_un  = 3 ;
const sz  XSCORE_TYPE_C_2     = 4 ;
const sz  XSCORE_TYPE_C_2_x   = 5 ;
const sz  XSCORE_TYPE_C_2_un  = 6 ;
const sz  XSCORE_TYPE_C_ar    = 7 ;
const sz  XSCORE_TYPE_C_ar_x  = 8 ;
const sz  XSCORE_TYPE_C_ar_un = 9 ;
const sz  XSCORE_TYPE_C_1     = 10;
const sz  XSCORE_TYPE_C_1_x   = 11;
const sz  XSCORE_TYPE_C_1_un  = 12;
const sz  XSCORE_TYPE_C_cat   = 13;
const sz  XSCORE_TYPE_N_3_h   = 14;
const sz  XSCORE_TYPE_N_3     = 15;
const sz  XSCORE_TYPE_N_3_un  = 16;
const sz  XSCORE_TYPE_N_pl3_h = 17;
const sz  XSCORE_TYPE_N_pl3   = 18;
const sz  XSCORE_TYPE_N_pl3_u = 19;
const sz  XSCORE_TYPE_N_2_h   = 20;
const sz  XSCORE_TYPE_N_2     = 21;
const sz  XSCORE_TYPE_N_2_un  = 22;
const sz  XSCORE_TYPE_N_ar_h  = 23;
const sz  XSCORE_TYPE_N_ar    = 24;
const sz  XSCORE_TYPE_N_ar_un = 25;
const sz  XSCORE_TYPE_N_1     = 26;
const sz  XSCORE_TYPE_N_1_un  = 27;
const sz  XSCORE_TYPE_N_4     = 28;
const sz  XSCORE_TYPE_O_3_h   = 29;
const sz  XSCORE_TYPE_O_3     = 30;
const sz  XSCORE_TYPE_O_3_un  = 31;
const sz  XSCORE_TYPE_O_2     = 32;
const sz  XSCORE_TYPE_O_2_un  = 33;
const sz  XSCORE_TYPE_O_co2   = 34;
const sz  XSCORE_TYPE_S_3_h   = 35;
const sz  XSCORE_TYPE_S_3     = 36;
const sz  XSCORE_TYPE_S_3_un  = 37;
const sz  XSCORE_TYPE_S_2     = 38;
const sz  XSCORE_TYPE_S_2_un  = 39;
const sz  XSCORE_TYPE_S_o     = 40;
const sz  XSCORE_TYPE_P_3     = 41;
const sz  XSCORE_TYPE_F       = 42;
const sz  XSCORE_TYPE_Cl      = 43;
const sz  XSCORE_TYPE_Br      = 44;
const sz  XSCORE_TYPE_I       = 45;
const sz  XSCORE_TYPE_H       = 46;
const sz  XSCORE_TYPE_H_hb    = 47;
const sz  XSCORE_TYPE_Si      = 48;
const sz  XSCORE_TYPE_O_w     = 49;
const sz  XSCORE_TYPE_M_      = 50;
const sz  XSCORE_TYPE_Un      = 51;
const sz  XSCORE_TYPE_SIZE    = 52;
...
const fl XSCORE_vdw_radii[] = {
        2.100, // XSCORE_TYPE_C_3
        2.100, // XSCORE_TYPE_C_3_x
        2.100, // XSCORE_TYPE_C_3_un
        1.900, // XSCORE_TYPE_C_2
        1.900, // XSCORE_TYPE_C_2_x
        1.900, // XSCORE_TYPE_C_2_un
        2.000, // XSCORE_TYPE_C_ar
        2.000, // XSCORE_TYPE_C_ar_x
        2.000, // XSCORE_TYPE_C_ar_un
        1.800, // XSCORE_TYPE_C_1
        1.800, // XSCORE_TYPE_C_1_x
        1.800, // XSCORE_TYPE_C_1_un
        1.900, // XSCORE_TYPE_C_cat
        1.800, // XSCORE_TYPE_N_3_h
        1.800, // XSCORE_TYPE_N_3
        1.800, // XSCORE_TYPE_N_3_un
        1.750, // XSCORE_TYPE_N_pl3_h
        1.750, // XSCORE_TYPE_N_pl3
        1.750, // XSCORE_TYPE_N_pl3_u
        1.750, // XSCORE_TYPE_N_2_h
        1.750, // XSCORE_TYPE_N_2
        1.750, // XSCORE_TYPE_N_2_un
        1.750, // XSCORE_TYPE_N_ar_h
        1.750, // XSCORE_TYPE_N_ar
        1.750, // XSCORE_TYPE_N_ar_un
        1.750, // XSCORE_TYPE_N_1
        1.750, // XSCORE_TYPE_N_1_un
        1.800, // XSCORE_TYPE_N_4
        1.650, // XSCORE_TYPE_O_3_h
        1.650, // XSCORE_TYPE_O_3
        1.650, // XSCORE_TYPE_O_3_un
        1.550, // XSCORE_TYPE_O_2
        1.550, // XSCORE_TYPE_O_2_un
        1.550, // XSCORE_TYPE_O_co2
        2.100, // XSCORE_TYPE_S_3_h
        2.100, // XSCORE_TYPE_S_3
        2.100, // XSCORE_TYPE_S_3_un
        2.000, // XSCORE_TYPE_S_2
        2.000, // XSCORE_TYPE_S_2_un
        2.000, // XSCORE_TYPE_S_o
        2.000, // XSCORE_TYPE_P_3
        1.500, // XSCORE_TYPE_F
        1.750, // XSCORE_TYPE_Cl
        1.900, // XSCORE_TYPE_Br
        2.050, // XSCORE_TYPE_I
        1.000, // XSCORE_TYPE_H
        1.000, // XSCORE_TYPE_H_hb
        2.000, // XSCORE_TYPE_Si
        1.750, // XSCORE_TYPE_O_w
        1.250, // XSCORE_TYPE_M_
        0.000, // XSCORE_TYPE_Un
};
...
inline fl XSCORE_radius(sz t) {
    const sz n = sizeof(XSCORE_vdw_radii) / sizeof(const fl);
    assert(n == XSCORE_TYPE_SIZE);
    assert(t < n);
    return XSCORE_vdw_radii[t];
}
